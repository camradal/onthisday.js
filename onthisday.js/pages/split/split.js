(function () {
    ...
    function loadArticle(item) {
        ...
        onthisday.getContent(link.title).done(function (data) {
            var articleText = '';
            var sections = data.mobileview.sections;
            sections.forEach(function (section) {
                articleText += section.text;
            });
            articleText = onthisday.format(articleText);
            articleText = toStaticHTML(articleText);
